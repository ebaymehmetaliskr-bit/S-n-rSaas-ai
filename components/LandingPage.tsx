          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
              ...
              <div className="hidden md:flex md:items-center md:space-x-8">
                ...
                <button onClick={onLogin} className="text-gray-500 hover:text-gray-900">Giriş Yap</button>
          ...
          <section className="py-20 bg-white">
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="mt-12 bg-gray-200 rounded-lg shadow-inner overflow-hidden" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1px' }}>
                ...
                <div className="bg-gray-100 p-4 font-bold text-xl text-primary-700">✅ SınırSaaS (AI Ajan Otopilotu)</div>
          ...
          <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
            <div className="flex flex-wrap justify-between gap-8">
              ...
              <div className="w-1/2 md:w-auto">
                <h3 className="text-sm font-semibold text-gray-900 tracking-wider uppercase">Özellikler</h3>
                <ul className="mt-4 space-y-4">
                  <li><a href="#features" className="text-base text-gray-500 hover:text-gray-900">Nasıl Çalışır</a></li>
                  <li><a href="#" className="text-base text-gray-500 hover:text-gray-900">Fiyatlandırma</a></li>
                  <li><a href="#" className="text-base text-gray-500 hover:text-gray-900">AI Asistan</a></li>
                </ul>
              </div>
              <div className="w-1/2 md:w-auto">
                <h3 className="text-sm font-semibold text-gray-900 tracking-wider uppercase">Şirket</h3>
                <ul className="mt-4 space-y-4">
                  <li><a href="#" className="text-base text-gray-500 hover:text-gray-900">Hakkımızda</a></li>
                  <li><a href="#" className="text-base text-gray-500 hover:text-gray-900">Blog</a></li>
                  <li><a href="#" className="text-base text-gray-500 hover:text-gray-900">Kariyer</a></li>
                </ul>
              </div>
              <div className="w-1/2 md:w-auto">
                <h3 className="text-sm font-semibold text-gray-900 tracking-wider uppercase">Yasal</h3>
                <ul className="mt-4 space-y-4">
                  <li><a href="#" className="text-base text-gray-500 hover:text-gray-900">Gizlilik Politikası</a></li>
                  <li><a href="#" className="text-base text-gray-500 hover:text-gray-900">KVKK Aydınlatma Metni</a></li>
                  <li><a href="#" className="text-base text-gray-500 hover:text-gray-900">Kullanım Şartları</a></li>
                </ul>
              </div>
            </div>
            <div className="mt-8 border-t border-gray-200 pt-8 text-center">
              <p className="text-base text-gray-500">&copy; 2025 SınırSaaS. Tüm hakları saklıdır.</p>
            </div>
          </div>
        </footer>
      </div>
