        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex md:items-center md:space-x-8">
              ...
              <button onClick={onLogin} className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700">
                ÜCRETSİZ TESTE BAŞLA
              </button>
            </div>
            <div className="md:hidden">
              <button onClick={onLogin} className="inline-flex items-center px-3 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700">
                TESTE BAŞLA
              </button>
            </div>
          </div>
      ...
      <main className="pt-16">
        ...
        <div className="bg-white">
          <div className="max-w-4xl mx-auto text-center py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
            ...
            <button onClick={onLogin} className="mt-10 inline-flex items-center justify-center px-8 py-4 border border-transparent text-base md:text-lg font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 transform transition-transform duration-200 hover:scale-105">
        ...
        <section className="bg-gray-800">
          <div className="max-w-4xl mx-auto text-center py-16 px-4 sm:py-20 sm:px-6 lg:px-8">
            ...
            <button onClick={onLogin} className="mt-8 inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700">
